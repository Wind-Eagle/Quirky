...
TEST(CoreMovesSimpleMovegen, Startpos) {
...
TEST(CoreMovesSimpleMovegen, Sicilian) {
...
TEST(CoreMovesSimpleMovegen, Sicilian2) {
    TestSimpleMovegen(
...
TEST(CoreMovesSimpleMovegen, EnPassant) {
    TestSimpleMovegen(
...
TEST(CoreMovesSimpleMovegen, Promotion) {
    TestSimpleMovegen(
...
TEST(CoreMovesSimpleMovegen, Castling1) {
    TestSimpleMovegen(
...
TEST(CoreMovesSimpleMovegen, Castling2) {
    TestSimpleMovegen(
...
TEST(CoreMovesSimpleMovegen, Castling3) {
    TestSimpleMovegen(
...
TEST(CoreMovesSimpleMovegen, Castling4) {
    TestSimpleMovegen(
...
TEST(CoreMovesSimpleMovegen, TrickyBoard) {
    TestSimpleMovegen(
        "1B2q2n/PPPPPPPP/8/2KRrk2/8/8/pppppppp/1b2Q2N w - - 0 1",
        "a7a8b a7a8n a7a8q a7a8r c5b4 c5b5 c5b6 c5c4 c5c6 c5d4 c5d6 c7c8b c7c8n c7c8q c7c8r d5d2 d5d3 d5d4 d5d6 d5e5 d7d8b d7d8n d7d8q d7d8r d7e8b d7e8n d7e8q d7e8r e1b1 e1c1 e1d1 e1d2 e1e2 e1f1 e1f2 e1g1 f7e8b f7e8n f7e8q f7e8r f7f8b f7f8n f7f8q f7f8r g7g8b g7g8n g7g8q g7g8r g7h8b g7h8n g7h8q g7h8r h1f2 h1g3");
}
